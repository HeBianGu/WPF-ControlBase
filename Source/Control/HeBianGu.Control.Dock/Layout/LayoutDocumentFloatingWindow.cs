...
namespace HeBianGu.Control.Dock.Layout
{
		...
		public override void ReadXml(XmlReader reader)
		{
			...
			while (true)
			{
				...
				else
				{
					...
					if (type == null) throw new ArgumentException("HeBianGu.Control.Dock.LayoutDocumentFloatingWindow doesn't know how to deserialize " + reader.LocalName);
