...
namespace HeBianGu.Control.Dock.Commands
{
	/// <summary>
	/// Class WeakFunc.
	/// </summary>
	...
	/// <seealso cref="HeBianGu.Control.Dock.Commands.WeakFunc{TResult}" />
	/// <seealso cref="HeBianGu.Control.Dock.Commands.IExecuteWithObjectAndResult" />
