...
using HeBianGu.Control.Dock.Commands;
using HeBianGu.Control.Dock.Converters;
...
namespace HeBianGu.Control.Dock.Controls
{
	...
	/// <summary>
	/// Class visualizes floating <see cref="LayoutAnchorable"/> (toolwindows) in HeBianGu.Control.Dock.
	/// </summary>
