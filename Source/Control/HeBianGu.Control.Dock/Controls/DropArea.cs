...
namespace HeBianGu.Control.Dock.Controls
{
	...
	{
		/// <summary> This type of drop area identifies a <seealso cref="HeBianGu.Control.Dock.DockingManager"/> which is the visual root of the HeBianGu.Control.Dock control library.</summary>
		DockingManager,
