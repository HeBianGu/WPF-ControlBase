...
namespace HeBianGu.Control.PropertyGrid
{
    ...
    public static class PropertyExtention
    {
        ...
        {
            PropertyAttribute editor = info.GetCustomAttribute<PropertyAttribute>();
        ...
        {
            if (info.PropertyType == typeof(int)) return new IntPropertyItem(info, obj);
            if (info.PropertyType == typeof(double)) return new DoublePropertyItem(info, obj);
