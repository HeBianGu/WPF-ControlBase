...
namespace HeBianGu.Base.WpfBase
{
    ...
    public partial class ServiceRegistry
    {
        ...
        {
            return (ILogService)((object)this.DoGetService(typeof(ILogService), this._defaultKey, true));
        }
        ...
        public void Register(Type interfaceType, Type classType)
        {
            ...
            var method = this.GetType().GetMethods().Where(l => l.Name == nameof(Register) && l.GetGenericArguments().Count() == 2 && l.GetParameters().Count() == 0);
        ...
        public IEnumerable<TService> GetAllAssignableFrom<TService>()
        {
            ...
            {
                foreach (var item in this._factories.Where(l => typeof(TService).IsAssignableFrom(l.Key)))
                {
            ...
            foreach (var item in this._instancesRegistry.Where(l => typeof(TService).IsAssignableFrom(l.Key)))
            {
