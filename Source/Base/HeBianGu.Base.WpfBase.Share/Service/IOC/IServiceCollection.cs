...
namespace HeBianGu.Base.WpfBase
{
    ...
    public static class ServiceCollectionExtention
    {
        ...
        public static IServiceCollection AddSingleton<T>(this IServiceCollection service, T obj) where T : class
        {
            ServiceRegistry.Instance.RegisterWithInstance<T>(obj);
            return service;
        }
