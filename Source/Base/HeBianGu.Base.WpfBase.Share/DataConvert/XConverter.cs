...
namespace HeBianGu.Base.WpfBase
{
    public sealed class XConverter
    {
        ...
        public static WriteLineObjectConverter WriteLineObjectConverter
        {
            get { return new WriteLineObjectConverter(); }
        }

        public static DisplayMapConverter DisplayMapConverter
        {
