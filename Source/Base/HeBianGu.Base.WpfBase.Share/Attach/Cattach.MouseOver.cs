...
namespace HeBianGu.Base.WpfBase
{
    static partial class Cattach
    {
        ...
        static public void OnMouseOverBorderThicknessChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        static public void OnMouseOverEffectChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            DependencyObject control = d as DependencyObject;
