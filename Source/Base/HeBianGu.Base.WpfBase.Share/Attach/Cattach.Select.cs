...
namespace HeBianGu.Base.WpfBase
{
    static partial class Cattach
    {
        ...
        static public void OnSelectBorderBrushChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        static public void OnSelectBorderThicknessChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            DependencyObject control = d as DependencyObject;
        ...
        static public void OnSelectEffectChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            DependencyObject control = d as DependencyObject;
    ...
    "SelectedText", typeof(string), typeof(Cattach), new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnSelectedTextChanged));
        ...
        public static readonly DependencyProperty SelectedOpacityProperty =
            DependencyProperty.RegisterAttached("SelectedOpacity", typeof(double), typeof(Cattach), new FrameworkPropertyMetadata(default(double), OnSelectedOpacityChanged));
        ...
        public static readonly DependencyProperty UnSelectedOpacityProperty =
            DependencyProperty.RegisterAttached("UnSelectedOpacity", typeof(double), typeof(Cattach), new FrameworkPropertyMetadata(default(double), OnUnSelectedOpacityChanged));
