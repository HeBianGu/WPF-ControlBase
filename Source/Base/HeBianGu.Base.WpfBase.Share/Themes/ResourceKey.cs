...
namespace HeBianGu.Base.WpfBase
{
    ...
    public static class StoryBoardKeys
    {
        ...
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.RotateForever.2");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.RotateForever.3");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.RotateForever.4");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.RotateForever.5");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.OpacityForever.0");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.ScaleTransform.XY");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.ScaleTransform.X");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.ScaleTransform.Y");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Close.Opacity");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.Scale.XY");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.Scale.X");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.Scale.Y");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), ".Storyboard.Load.OpacityRightToLeft");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.OpacityLeftToRight");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.OpacityDownToUp");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.WaitDownToUp");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.OpacityUpToDwon");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Load.Fountain");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.SlowHide");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.SlowShow");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Scale.Recovery");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Scale.Recovery.1.2");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Scale.Recovery.1.4");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Scale.Enlarge.1.2");

        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Scale.Enlarge.1.2.Recovery2");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.FontSize.Rebound");
        //public static ComponentResourceKey EventError => new ComponentResourceKey(typeof(StoryBoardKeys), "S.Storyboard.Color.Flash");
