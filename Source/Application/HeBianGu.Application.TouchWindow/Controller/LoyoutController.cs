...
namespace HeBianGu.Application.TouchWindow
{
    ...
    internal class LoyoutController : LoyoutControllerBase
    {
        ...
        [GuideMessage(DisplayName = "身高体重", ImagePath = "/HeBianGu.Application.TouchWindow;component/Resources/身高测量.png", Message = "现在开始身高体重测量，请站稳站直目视前方。")]
        ...
        [GuideMessage(DisplayName = "脂肪", ImagePath = "/HeBianGu.Application.TouchWindow;component/Resources/脂肪测量示意图19.12.30.png", Message = "现在开始脂肪测量，请双手伸直握住脂肪仪手柄。")]
        ...
        [GuideMessage(DisplayName = "血氧", ImagePath = "/HeBianGu.Application.TouchWindow;component/Resources/血氧测量示意图.png", Message = "现在开始血氧测量，请将血氧仪探头夹住手指进行测量。")]
        ...
        [GuideMessage(DisplayName = "血压", ImagePath = "/HeBianGu.Application.TouchWindow;component/Resources/血压测量示意图19.12.30.png", Message = "现在开始血压测量，请将手臂放置到肘垫处，保持安静松，点击“开始”按钮测量。")]
        ...
        [GuideMessage(DisplayName = "体温", ImagePath = "/HeBianGu.Application.TouchWindow;component/Resources/体温测量示意图.png", Message = "请拿起体温枪对准额头前方0-5cm处，按下测量按钮测量。")]
