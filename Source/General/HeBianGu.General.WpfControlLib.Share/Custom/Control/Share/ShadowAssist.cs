...
namespace HeBianGu.General.WpfControlLib
{
    ...
    public static class ShadowAssist
    {
        ...
        private static void DarkenPropertyChangedCallback(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            DropShadowEffect dropShadowEffect = uiElement?.Effect as DropShadowEffect;
            ...
            if ((bool)dependencyPropertyChangedEventArgs.NewValue)
            {
                ...
                DoubleAnimation doubleAnimation = new DoubleAnimation(1, new Duration(TimeSpan.FromMilliseconds(350)))
                {
            ...
            else
            {
                ...
                DoubleAnimation doubleAnimation = new DoubleAnimation(shadowLocalInfo.StandardOpacity, new Duration(TimeSpan.FromMilliseconds(350)))
                {
                    FillBehavior = FillBehavior.HoldEnd
                };
                dropShadowEffect.BeginAnimation(DropShadowEffect.OpacityProperty, doubleAnimation);
