...
namespace HeBianGu.General.WpfControlLib
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/HeBianGu.General.WpfControlLib;component/CustomControls/DialogControl/Shadows.xaml", UriKind.Absolute) };
