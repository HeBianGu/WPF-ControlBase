...
namespace HeBianGu.General.WpfControlLib
{
    public class TransitionEffect : TransitionEffectBase
    {
        ...
        {
            DiscreteDoubleKeyFrame zeroFrame = new DiscreteDoubleKeyFrame(from);
            DiscreteDoubleKeyFrame startFrame = new DiscreteDoubleKeyFrame(from, initialOffset + OffsetTime);
            EasingDoubleKeyFrame endFrame = new EasingDoubleKeyFrame(to, initialOffset + OffsetTime + Duration) { EasingFunction = new SineEase() };
        ...
        private Timeline CreateExpandIn(ITransitionEffectSubject effectSubject)
        {
            ...
            DiscreteDoubleKeyFrame zeroFrame = new DiscreteDoubleKeyFrame(0.0);
            DiscreteDoubleKeyFrame startFrame = new DiscreteDoubleKeyFrame(.5, effectSubject.Offset + OffsetTime);
            EasingDoubleKeyFrame endFrame = new EasingDoubleKeyFrame(1, effectSubject.Offset + OffsetTime + Duration) { EasingFunction = new SineEase() };
            ...
            DoubleAnimationUsingKeyFrames scaleYAnimation = scaleXAnimation.Clone();
