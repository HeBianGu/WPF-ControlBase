...
namespace HeBianGu.General.WpfControlLib
{
    public class AnimationPath : Shape
    {
        ...
        public static readonly DependencyProperty PathLengthProperty = DependencyProperty.Register(
            "PathLength", typeof(double), typeof(AnimationPath), new FrameworkPropertyMetadata(0.0, OnPropertiesChanged));
        ...
        public static readonly DependencyProperty IsPlayingProperty = DependencyProperty.Register(
            ...
            {
                AnimationPath ctl = (AnimationPath)o;
        ...
        static AnimationPath()
        {
            ...
            StrokeThicknessProperty.AddOwner(typeof(AnimationPath), new FrameworkPropertyMetadata(1.0, OnPropertiesChanged));
        }
